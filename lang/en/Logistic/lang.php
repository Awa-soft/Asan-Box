...
return [
    ...
    'warehouse'=>[
        ...
        'singular_label'=>'Warehouse'
    ],
    'warehouse_item'=>[
        'plural_label'=>'Warehouse Items',
        'singular_label'=>'Warehouse Item'
    ],
    'branch_item'=>[
    ...
    'reports'=>[
        'label'=>"Logistics",
        "logisticBranches"=>"Branches Report",
        'logisticWarehouse'=>"Warehouses Report",
        "logisticItemTransactions"=>"Item Transaction Report"
    ]
];
