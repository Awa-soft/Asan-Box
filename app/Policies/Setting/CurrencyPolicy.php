...
class CurrencyPolicy
{
    ...
    {
        return $user->can('update_setting::currency');
    }
    ...
    {
        return $user->can('delete_any_setting::currency');
    }
    ...
    {
        return $user->can('force_delete_any_setting::currency');
    }
    ...
    {
        return $user->can('restore_any_setting::currency');
    }
    ...
    {
        return $user->can('replicate_setting::currency');
    }
    ...
    {
        return $user->can('reorder_setting::currency');
    }
}
