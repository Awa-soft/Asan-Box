...
class ExpensePolicy
{
    ...
    {
        return $user->can('force_delete_finance::expense');
    }
    ...
    {
        return $user->can('force_delete_any_finance::expense');
    }
    ...
    {
        return $user->can('restore_finance::expense');
    }
    ...
    {
        return $user->can('restore_any_finance::expense');
    }
    ...
    {
        return $user->can('replicate_finance::expense');
    }
    ...
    {
        return $user->can('reorder_finance::expense');
    }
}
