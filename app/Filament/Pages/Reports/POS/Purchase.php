...
class Purchase extends Page
{
    ...
    protected static ?string $slug = 'reports/pos/purchase/{from}/{to}/{contact}/{branch}/{type}';
    ...
    public function mount($from,$to,$branch,$contact,$type):void{
        ...
        $this->data = \App\Models\POS\PurchaseInvoice::
    ...
    protected static string $view = 'filament.pages.reports.p-o-s.purchase';
}
