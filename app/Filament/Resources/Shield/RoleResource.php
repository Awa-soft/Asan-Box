...
class RoleResource extends Resource implements HasShieldPermissions
{
    ...
    {
        return trans('Settings/lang.role.plural_label');
    }
    public static function getPluralModelLabel(): string
    {
        return trans('Settings/lang.role.singular_label');
    }
    ...
    public static function getResourceEntitiesSchema(): ?array
    {
        return collect(FilamentShield::getResources())
            ...
            ->map(function ($entity) {
                ...
                $resource = new $entity['fqcn']();
                return Forms\Components\Section::make($sectionLabel)
                ->icon($resource::getNavigationIcon())
                ->iconColor('primary')
                    ->description(fn () => new HtmlString('<span style="word-break: break-word;">' . $resource::getNavigationGroup() . '</span>'))
                    ->compact()
                    ->schema([
    ...
    public static function getPageOptions(): array
    {
        return collect(FilamentShield::getPages())
            ->flatMap(fn ($page) => [
             ...
             ->filter(fn($value) => ($value !== '' && $value !== 'Package Page') )
            ->toArray();
    }
